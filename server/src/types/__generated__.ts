...
export type Power = {
  ...
  power_id: Scalars['ID']['output'];
  range?: Maybe<Scalars['String']['output']>;
  rangeMultiplier?: Maybe<Scalars['String']['output']>;
  rank?: Maybe<Rank>;
...
export type PowerResolvers<ContextType = any, ParentType extends ResolversParentTypes['Power'] = ResolversParentTypes['Power']> = {
  ...
  power_id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  range?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  rangeMultiplier?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
